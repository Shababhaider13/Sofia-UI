...
<div>        
    ...
    <!-- profile end -->
    <div class="del1 head1txt" style="margin: 0; padding-left:10px;">Profile Description</div>
    <div class="stext-102" id="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eleifend nunc justo, a dictum risus faucibus vitae.</div>
    <!-- accordation start -->
